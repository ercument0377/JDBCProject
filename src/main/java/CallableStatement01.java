...
public class CallableStatement01 {
    public static void main(String[] args) throws ClassNotFoundException, SQLException {
        /*
        Java da meyhodlar return type sahibi olsada olmasada method olarak adlandırılır
        SQL de ise data return ediliyorsa "function" denir. Return yapmıyorsa "procedure" olarak adlandırılır.
         */
